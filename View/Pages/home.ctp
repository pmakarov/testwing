...
App::uses('Session', 'Debugger', 'Utility');
         ...
         <div class="row-fluid">
         	<div class="span6">
	          ...
	          <p>Our mission is to provide a simple and intuitive interface that allows users to easily create and publish report content. Our goal has been to amplify and optimize the reporting process through the use of the following:</p>
	       	...
	       	<ul>
	       		<li><strong>DCMA Testing Dashboard</strong>: an easy-to-use workspace that allows you to manage, edit, and publish your reports</li>
	       		<li><strong>DCMA Test Report</strong>: a form built, not just to store your data, but to optimize the way in which you report. With the ability to add dynamic data, we hope to make reporting more powerful and personal</li>
	       	</ul>
		        ...
		        <form id="f" action="" class="cmxform">
		         ...
		         <div class="errorblock " id="loginErrorDiv" style="display:none">
					...
					<fieldset id="user-details">
						...
						<input id="time_zone" type="hidden" name="data[User][timezone]" value="" />
...
var tz = "<?php echo $this->Session->read('User.time_zone'); ?>";
var b = "<?php //echo $userLocation; ?>";
...
//console.log("session timezone: "+ tz);
		if(tz.length==0){
            var visitortime = new Date();
            var visitortimezone = -visitortime.getTimezoneOffset()/60;
            $("#time_zone").val(visitortimezone);
        }
        else {
        	$("#time_zone").val(tz);
        }
