<div class="transactions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('xmlfile'); ?></th>
			<th><?php echo $this->Paginator->sort('edifile'); ?></th>
			<th><?php echo $this->Paginator->sort('udffile'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($transaction['Transaction']['xmlfile']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['edifile']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['udffile']); ?>&nbsp;</td>
		<td>
